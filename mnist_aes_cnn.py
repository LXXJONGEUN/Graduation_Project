...
projection_x_train = projection_x_train.reshape(projection_x_train.shape[0], 2, 28, 1)
projection_x_test = projection_x_test.reshape(projection_x_test.shape[0], 2, 28, 1)
train = x_train_encrypt.reshape(x_train_encrypt.shape[0], 2, 28, 1)
test = x_test_encrypt.reshape(x_test_encrypt.shape[0], 2, 28, 1)
...
model_encrypt.add(Conv2D(32, kernel_size=2, padding='same', input_shape=(2,28,1)))
model_encrypt.add(Activation('relu'))
model_encrypt.add(Dropout(0.2))

model_encrypt.add(Conv2D(64, kernel_size=2, padding='same'))
model_encrypt.add(Activation('relu'))
model_encrypt.add(Dropout(0.3))

model_encrypt.add(Conv2D(128, kernel_size=2, padding='same'))
model_encrypt.add(Activation('relu'))
model_encrypt.add(Dropout(0.3))

model_encrypt.add(Conv2D(256, kernel_size=2, padding='same'))
model_encrypt.add(Activation('relu'))
model_encrypt.add(Dropout(0.3))
